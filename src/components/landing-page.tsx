    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className={cn(
                'text-sm font-medium hover:text-violet-500 transition-colors flex items-center gap-1',
                isDarkMode ? 'text-slate-300' : 'text-slate-600'
              )}
            >
        ...
        {isMobileMenuOpen && (
          ...
          >
            <a href="#features" className="py-2 text-lg font-medium">
              Recursos
            </a>
            <a href="#pricing" className="py-2 text-lg font-medium">
              Planos
            </a>
            ...
            <Link href={loginLink}>
              <button
                type="button"
                className="w-full py-3 font-bold text-center border rounded-xl"
              >
                Entrar
              </button>
            </Link>
            <Link href={loginLink}>
              <button
                type="button"
                className="w-full py-3 font-bold text-center bg-emerald-600 text-white rounded-xl"
              >
                Começar Agora
              </button>
            </Link>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className={cn(
              'absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full blur-[120px] opacity-40 animate-pulse',
              isDarkMode ? 'bg-emerald-900' : 'bg-emerald-200'
            )}
          />
          <div
            className={cn(
              'absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full blur-[120px] opacity-40 animate-pulse delay-1000',
              isDarkMode ? 'bg-emerald-800' : 'bg-emerald-300'
            )}
          />
          <div
            className={cn(
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <motion.p
                ...
                className={cn(
                  'text-lg md:text-xl mb-8 max-w-xl mx-auto lg:mx-0',
                  isDarkMode ? 'text-slate-400' : 'text-slate-600'
                )}
              >
                O Zenit Finance combina design intuitivo com poder analítico
                para você alcançar a liberdade financeira mais rápido.
              </motion.p>
            ...
            >
              <div
                className={cn(
                  ...
                  isDarkMode
                    ? 'bg-[#111] border-white/10 shadow-emerald-900/20'
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            >
              Ferramentas poderosas simplificadas para o seu dia a dia. Controle
              total na palma da sua mão.
            </p>
          </div>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 text-white">
          ...
          <p className="text-xl text-emerald-100 mb-10 max-w-2xl mx-auto">
            Junte-se a milhares de usuários que já estão no controle. Crie sua
            conta gratuita hoje mesmo.
          </p>
          <Link href={loginLink}>
            <button
              type="button"
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              onClick={onNavigateToTechCompany}
              className={cn(
                'text-xs font-medium hover:underline text-left',
                isDarkMode
          ...
          <div className="flex gap-6">
            <a
              href="/"
              className={cn(
                'text-sm hover:text-emerald-500 transition-colors',
                isDarkMode ? 'text-slate-400' : 'text-slate-500'
              )}
            >
              Termos
